                ...
                <div class="row">
                    ...
                    <form action="pages/proses_barang.php?aksi=updatebarang" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Nama Barang" name="nama_barang" value="<?=$row['nama_barang']?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Spesifikasi</label>
                                <textarea placeholder="Spesifikasi" name="spesifikasi" rows="4" cols="58"><?=$row['spesifikasi']?></textarea>
                            </div>
                           <div class="form-group">
                                <label>Lokasi</label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group" >
                                ...
                                <select name="kategori" class="form-control" value="<?=$row['kategori']?>" required>
                        ...
                        <div class="form-group">
                                <label>Kondisi</label>
                                <select name="kondisi" class="form-control" value="<?=$row['kondisi']?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Sumber Dana" value="<?=$row['sumber_dana']?>" name="sumber_dana" class="form-control" required>
                        </div>
                    </div>
